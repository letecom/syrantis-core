...
- The query should exclude `Syrantis/Processed`, `Syrantis/Ignored`, and `Syrantis/Failed` labels to
  avoid repeated intake attempts.
- A documented broad intake query for approved client validation is:
